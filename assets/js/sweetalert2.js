!(function (n, t) {
    ...
    var n = {
        ...
        x = function (n) {
            ...
            var w = E(),
                ...
                h = D();
            if (
                (n.titleText ? (u.innerText = n.titleText) : n.title && (u.innerHTML = n.title.split("\n").join("<br />")),
                "string" == typeof n.backdrop ? (E().style.background = n.backdrop) : n.backdrop || Q([document.documentElement, document.body], o["no-backdrop"]),
                n.html ? I(n.html, d) : n.text ? ((d.textContent = n.text), G(d)) : nn(d),
                n.position in o ? Q(w, o[n.position]) : (r('The "position" parameter is not valid, defaulting to "center"'), Q(w, o.center)),
            ...
            "function" == typeof n.animation && (n.animation = n.animation.call()),
                ...
                (t.className = o.popup),
                n.toast ? (Q([document.documentElement, document.body], o["toast-shown"]), Q(t, o.toast)) : Q(t, o.modal),
            ...
            n.progressSteps && n.progressSteps.length
                ? (G(k),
                  tn(k),
                  y >= n.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
                ...
                return new Promise(function (t, e) {
                    ...
                    s.toast && g && ((window.onkeydown = b), (g = !1)),
                                ...
                                if ("Enter" !== e.key || e.isComposing)
                                    if ("Tab" === e.key) {
                                        ...
                                        -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key)
                                            ...
                                            : ("Escape" !== e.key && "Esc" !== e.key) || !0 !== p(s.allowEscapeKey) || r(n.DismissReason.esc);
                                else if (e.target === u()) {
                        ...
                        (n.enableInput = function () {
                            var n = u();
                            if (!n) return !1;
                            if ("radio" === n.type) for (var t = n.parentNode.parentNode.querySelectorAll("input"), e = 0; e < t.length; e++) t[e].disabled = !1;
                            else n.disabled = !1;
                        }),
                        (n.disableInput = function () {
                            var n = u();
                            if (!n) return !1;
                            if (n && "radio" === n.type) for (var t = n.parentNode.parentNode.querySelectorAll("input"), e = 0; e < t.length; e++) t[e].disabled = !0;
                            else n.disabled = !0;
                        }),
                    ...
                    if ("select" === s.input || "radio" === s.input) {
                        ...
                        s.inputOptions instanceof Promise
                            ...
                            ? En(s.inputOptions)
                            : i("Unexpected type of inputOptions! Expected object, Map or Promise, got " + w(s.inputOptions));
                    }
                    (wn = s.animation),
                        (un = s.onBeforeOpen),
                        (dn = s.onOpen),
                        ...
                        s.toast || (p(s.allowEnterKey) ? (s.focusCancel && en(I) ? I.focus() : s.focusConfirm && en(T) ? T.focus() : $(-1, 1)) : document.activeElement && document.activeElement.blur()),
                        (E().scrollTop = 0);
                });
            }
        };
    (v.isVisible = function () {
            ...
            if (e) {
                ...
                var a = function () {
                    t.parentNode && t.parentNode.removeChild(t),
                        F([document.documentElement, document.body], [o.shown, o["no-backdrop"], o["has-input"], o["toast-shown"]]),
                        X() &&
        ...
        (v.DismissReason = Object.freeze({ cancel: "cancel", backdrop: "overlay", close: "close", esc: "esc", timer: "timer" })),
        (v.noop = function () {}),
        (v.version = "7.12.15"),
        (v.default = v),
    ...
    var C = { previousActiveElement: null, previousBodyPadding: null },
        ...
        I = function (n, t) {
            ...
            if ("object" === (void 0 === n ? "undefined" : w(n)))
                if (((t.innerHTML = ""), 0 in n)) for (var e = 0; e in n; e++) t.appendChild(n[e].cloneNode(!0));
